...
public class Join {
    ...
    Map<Integer, List<Object>> innerJoin(Map<Integer, String> tabla1, Map<Integer, Integer> tabla2) {
        ...
        Map<Integer, String> resultadoFila = new HashMap<>();

        for (Map<String, Object> fila1 : this.tabla1) {
            for (Map<String, Object> fila2 : this.tabla2) {
                if (fila1.get("id").equals(fila2.get("id"))) {
                    resultadoFila.putAll(fila1);
